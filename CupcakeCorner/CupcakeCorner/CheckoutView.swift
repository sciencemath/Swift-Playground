    ...
    var body: some View {
        ScrollView {
            VStack {
                ...
                .frame(height: 233) // here so when the image is finally loaded it won't jump around
        ...
        .alert("Error", isPresented: $showingPostError) {
            Button("OK") { }
        } message: {
            Text("Error Posting, check internet connection or URL")
        }
    }
